...
#define BIKEOS_FIRMWARE_VERSION "0.7.0"
...
// 1.2: Phase H added accelMilliG to the Sensor Data payload (5 -> 7 bytes)
// so Android can do real MPU-based riding-style analysis instead of the
// old max/avg-speed-ratio heuristic. See ble_service.cpp + BlePacket.kt.
#define BIKEOS_PROTOCOL_VERSION "1.2"
